  ...
  <view class="container">
    ...
    <swiper class="banner" indicator-dots="true" autoplay="true" interval="3000" duration="1000">
      <swiper-item v-for="item in banner" :key="item.id">
        <navigator url=""><image :src="item.image_url" background-size="cover"></image></navigator>
      </swiper-item>
    </swiper>
    <view class="m-menu">
      <navigator v-for="item in channel" :key="item.id" class="item" url="">
    ...
    <view class="a-section a-brand">
      <view class="h">
        <navigator url="../brand/brand"><text class="txt">品牌制造商直供</text></navigator>
      </view>
      <view class="b">
        <view class="item item-1" v-for="item in brandList" :key="item.id">
          <navigator url="/pages/brandDetail/brandDetail">
            <view class="wrap">
    ...
    <view class="a-section a-new">
      <view class="h">
        <view>
          <navigator url="../newGoods/newGoods"><text class="txt">周一周四 · 新品首发</text></navigator>
        </view>
      </view>
      <view class="b">
        <view class="item" v-for="item in newGoodsList" :key="item.id">
    ...
    <view class="a-section a-popular">
      <view class="h">
        <view>
          <navigator url="../hotGoods/hotGoods"><text class="txt">人气推荐</text></navigator>
        </view>
      </view>
      <view class="b">
    ...
    <view class="a-section a-topic">
      <view class="h">
        <view>
          <navigator url="../topic/topic" open-type="switchTab"><text class="txt">专题精选</text></navigator>
        </view>
      </view>
      <view class="b">
        <scroll-view scroll-x="true" class="list">
          <view class="item" v-for="item in topicList" :key="item.id">
    ...
    <view class="good-grid" v-for="item in categoryList" :key="item.id">
      <view class="h">
        <view>
          <text>{{ item.name }}</text>
        </view>
      ...
      <view class="b">
        <navigator url="../goods/goods" class="item" v-for="obj in item.goodsList" :key="obj.id">
          <image class="img" :src="obj.list_pic_url" background-size="cover"></image>
          <view class="name">{{ obj.name }}</view>
          <view class="price">￥{{ obj.retail_price }}</view>
        </navigator>
      </view>
    </view>
  </view>
...
export default {
  ...
  methods: {
    async initData() {
      const res = await uni.$http.get('/index/index')
